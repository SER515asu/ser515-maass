...
public class UserStoryFactory {
    ...
    public UserStory createNewUserStory(String name, String description, double pointValue, String sprint) {
        UserStory newUS = new UserStory(name, description, pointValue,sprint);
        return newUS;
    }
}
